...
initiating_window = pg.image.load("tic-tac-toe/modified_cover.png")
x_img = pg.image.load("tic-tac-toe/X_modified.png")
y_img = pg.image.load("tic-tac-toe/o_modified.png")
